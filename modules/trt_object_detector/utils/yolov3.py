...
class TrtYOLOv3(object):
    ...
    def _load_engine(self):
        try:
            TRTbin = 'modules/trt_object_detector/models/yolov3-416.trt'
            with open(TRTbin, 'rb') as f, trt.Runtime(self.trt_logger) as runtime:
                return runtime.deserialize_cuda_engine(f.read())
        except IOError:
            print("File not accessible")
            from modules.trt_object_detector.from_onnx_to_tensorrt.onnx_to_tensorrt import build_engine
            return build_engine('modules/trt_object_detector/from_onnx_to_tensorrt/yolov3-416.onnx',
                'modules/trt_object_detector/models/yolov3-416.trt', verbose=True)
