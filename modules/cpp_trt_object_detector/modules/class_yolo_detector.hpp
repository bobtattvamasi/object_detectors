...
//
//	std::string file_model_weights					=
//"configs/yolov3.weights";
//
//	float detect_thresh
//= 0.9;
//
 ...
 private:
  ...
  void build_net() {
    if ((_config.net_type == Config::YOLOV2) || (_config.net_type == Config::YOLOV2_TINY)) {
      ...
      assert(false &&
             "Unrecognised network_type. Network Type has to be one among the "
             "following : yolov2, yolov2-tiny, yolov3 and yolov3-tiny");
    }
  }
